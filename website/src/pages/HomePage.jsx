...
export default function HomePage() {
  return (
    <div className="min-h-[100dvh] bg-[#050505] text-white flex flex-col justify-between selection:bg-white selection:text-black">
      <div>
        ...
        <main className="max-w-5xl mx-auto px-4 py-8 md:py-16">
          ...
          <section className="mb-24">
            {/* Eyebrow Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3.5 py-1 text-[10px] font-mono uppercase tracking-[0.2em] text-zinc-400 mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse"></span>
              <span>Eloquix v1.0 &bull; Extension Companion</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white mb-6 leading-[1.08]">
          ...
          <section id="features" className="mb-28">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
              ...
              <span className="text-xs font-mono text-zinc-500">
                04 Core Modules &bull; Feed Native
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-white/[0.03] border border-white/10 p-2 rounded-[2rem] hover:border-white/20 transition-colors">
                <div className="bg-zinc-950 border border-white/5 rounded-[calc(2rem-0.5rem)] p-8 h-full flex flex-col justify-between">
                  <div>
              ...
              {/* Card 2 - Normal Span */}
              <div className="bg-white/[0.03] border border-white/10 p-2 rounded-[2rem] hover:border-white/20 transition-colors">
                <div className="bg-zinc-950 border border-white/5 rounded-[calc(2rem-0.5rem)] p-8 h-full flex flex-col justify-between">
                  <div>
                    <span className="text-[10px] font-mono text-zinc-500 block mb-3 uppercase tracking-widest">
                      02 &bull; Tonal Range
          ...
          <section className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white/[0.03] border border-white/10 p-2 rounded-[2rem]">
                <div className="bg-zinc-950 border border-white/5 rounded-[calc(2rem-0.5rem)] p-6">
          ...
          <section className="bg-white/[0.03] border border-white/10 p-2 rounded-[2.5rem]">
            <div className="bg-zinc-950 border border-white/5 rounded-[calc(2.5rem-0.5rem)] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
