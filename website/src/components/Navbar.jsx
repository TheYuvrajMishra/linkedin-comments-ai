...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-6 z-50 w-full max-w-5xl mx-auto px-4 mb-12">
      <div className="bg-zinc-950/80 border border-white/10 backdrop-blur-2xl rounded-full px-5 py-3 flex items-center justify-between shadow-2xl transition-all duration-500">
        {/* Brand Logo */}
